...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['owner', 'web-developer'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Form AS', path: '/form-as', entity: 'form_a', service: AccessServiceEnum.PROJECT, icon: FiFile },
    { name: 'Form BS', path: '/form-bs', entity: 'form_b', service: AccessServiceEnum.PROJECT, icon: FiFileMinus },
    { name: 'Form CS', path: '/form-cs', entity: 'form_c', service: AccessServiceEnum.PROJECT, icon: FiFileText },
    {
      name: 'Order Currents',
      path: '/order-currents',
    ...
    {
      name: 'Order History Clients',
      path: '/order-history-clients',
      entity: 'order_history_client',
      service: AccessServiceEnum.PROJECT,
      icon: FiClock,
    },
    {
      name: 'Order History Pharmacies',
      path: '/order-history-pharmacies',
      entity: 'order_history_pharmacie',
      service: AccessServiceEnum.PROJECT,
      icon: FiArchive,
    },
    { name: 'Pdf Files', path: '/pdf-files', entity: 'pdf_file', service: AccessServiceEnum.PROJECT, icon: FiFilePlus },
