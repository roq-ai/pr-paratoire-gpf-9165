...
import { getClientProfileById } from 'apiSdk/client-profiles';
...
function ClientProfileViewPage() {
  ...
  const { data, error, isLoading, mutate } = useSWR<ClientProfileInterface>(
    () => (id ? `/client-profiles/${id}` : null),
    () =>
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('client_profile', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/client-profiles/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                ...
                <FormListItem label="Name Pharmacy" text={data?.name_pharmacy} />
