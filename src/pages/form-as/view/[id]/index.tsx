...
import { getFormAById } from 'apiSdk/form-as';
...
import { PdfFileListPage } from 'pages/pdf-files';

function FormAViewPage() {
  ...
  const { data, error, isLoading, mutate } = useSWR<FormAInterface>(
    ...
    () =>
      getFormAById(id, {
        relations: ['client_profile', 'user', 'order_current_form_a_order_idToorder_current'],
      }),
  );
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('form_a', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/form-as/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                ...
                <FormListItem label="Sex" text={data?.sex} />

                <FormListItem label="Name Patient" text={data?.name_patient} />

                <FormListItem label="Medication Details" text={data?.medication_details} />
                ...
                {hasAccess('order_current', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                  <FormListItem
                    label="Order Current Form A Order Id Toorder Current"
                    text={
                      <Link
                        as={NextLink}
                        href={`/order-currents/view/${data?.order_current_form_a_order_idToorder_current?.id}`}
                      >
                        {data?.order_current_form_a_order_idToorder_current?.form_a_pdf_path}
                      </Link>
                    }
                  />
                )}
