...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  ...
  'Website.update': { roles: ['tenant-roles'], key: 'website_123', tenantPath: [], userPath: [] },
  'Bug.update': { roles: ['tenant-roles', 'tenant-owner-roles'], key: 'bug_123', tenantPath: [], userPath: [] },
};

const ownerRoles: string[] = ['owner'];
const customerRoles: string[] = ['customer'];
const tenantRoles: string[] = ['owner', 'web-developer'];
